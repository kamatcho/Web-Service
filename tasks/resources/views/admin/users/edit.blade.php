                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="name" class="form-control" id="form_control_1" placeholder="{{trans('admin.name')}}" value="{!! $user->name !!}">
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-10">
                                <input type="email" name="email" class="form-control" id="form_control_1" placeholder="{{trans('admin.email')}}"value="{!! $user->email !!}" >
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-10">
                                <select class="form-control" name="type">
                                    @if($user->type == 1)
                                    <option selected value="1">{!! trans('admin.admin') !!}</option>
                                    <option value="0">{!! trans('admin.user') !!}</option>
                                        @else
                                        <option  value="1">{!! trans('admin.admin') !!}</option>
                                        <option selected value="0">{!! trans('admin.user') !!}</option>
                                    @endif
                                </select>
                                <div class="form-control-focus"> </div>
