                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{url('admin/users/add')}}" class="btn sbold green"> {{trans('admin.add_user')}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-comments"></i>{{trans('admin.users')}} </div>
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            @foreach($users as $user)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{url('admin/users/edit/'.$user->id)}}" class="btn btn-circle purple btn-outline">{{trans('admin.edit')}}</a>

                                                    </td>
                                                    <td class="text-center">
                                                        <!-- Button trigger modal -->
                                                        <button type="button" class="btn btn-circle red btn-outline" data-toggle="modal" data-target="#myModal_{{$user->id}}">
                                                            {{trans('admin.remove')}}
                                                        </button>
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <h3>{{trans('admin.are_u_sure_u_want_to_delete')." ".$user->name}}</h3>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        {!! Form::open(['url'=>'admin/users/delete/'.$user->id]) !!}
