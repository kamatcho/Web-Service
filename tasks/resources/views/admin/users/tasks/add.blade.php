                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-10">
                                <select name="user" class="form-control">
                                    <option selected disabled>{!! trans('admin.please_select_user') !!}</option>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="task" class="form-control" id="form_control_1" placeholder="{{trans('admin.task')}}" >
                                <div class="form-control-focus"> </div>
